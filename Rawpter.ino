...
void controlANGLE2() {
  ...
  derivative_roll = (roll_IMU - roll_IMU_prev)/dt1; 
  ...
  derivative_pitch = (pitch_IMU - pitch_IMU_prev)/dt1;
  ...
  derivative_roll = (error_roll - error_roll_prev)/dt1; 
  ...
  derivative_pitch = (error_pitch - error_pitch_prev)/dt1; 
